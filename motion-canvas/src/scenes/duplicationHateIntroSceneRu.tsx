...
export default makeScene2D(function* (view) {
  ...
  // Keep background EXACTLY like introMergeSceneV2 (cool tint on top of applyBackground).
  ...
  const TEXT = 'Я ненавидел дублирование кода';
  ...
  const KEYWORDS = new Set([
    // Keep the same keyword set as introMergeScene (harmless for RU, but keeps the hook identical).
    'if',
    'else',
    'return',
    'case',
  ...
  const fontSize = fitFontSize(TEXT, maxWidth, fontFamily, 220, 72, fontWeight);
  const y = -40;
