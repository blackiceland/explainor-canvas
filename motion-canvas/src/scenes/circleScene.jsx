...
import { fetchCircleSlideScene } from '../services/animationClient';
function resolveTween(scene, propertyPath) {
...
export default makeScene2D(function* (view) {
    ...
    view.add(<Circle ref={circle} width={element.circle.radius * 2} height={element.circle.radius * 2} stroke={element.circle.style.strokeColor} fill={element.circle.style.fillColor} lineWidth={element.circle.style.lineWidth}/>);
