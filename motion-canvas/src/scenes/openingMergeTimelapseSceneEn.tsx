...
import {
  ...
  easeOutCubic, linear, spawn, ThreadGenerator, waitFor,
...
// Любое движение на выходе превращало каждый раунд в отдельный трюк, а
// строке в этот момент нечего добавлять к сказанному — ей надо просто уйти.
