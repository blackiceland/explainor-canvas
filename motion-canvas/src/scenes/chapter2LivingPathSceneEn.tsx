...
// Глава 2, «живой путь»: тот же цикл, что в Beat 1, но откатанный код —
// с confirmGrip вместо lift. Свет идёт по строкам, пока рука исполняет.
...
export default makeScene2D(function* (view) {
  ...
  // ── Confirm grip ──────────────────────────────────────────────────────
  // Честная физика проверки: хват дожимается и держит короткую паузу,
  // свет стоит на confirmGrip. Никаких UI-вспышек.
  yield* all(
