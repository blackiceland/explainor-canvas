...
export default makeProject({
    ...
    scenes: [
        ...
        // РЕШЕНИЕ + ГРАНИЦА, ОДНОЙ СЦЕНОЙ (слиты 22.08 по решению автора).
        // Часть I: у причин появляются имена — три одинаковых return null
        // становятся тремя случаями, табло откручивает NO SIGNAL в пять правд.
